...
namespace CommonHelper
{
    ...
    {
        //基本设置
        static private string path = @"ftp://" + "192.168.3.187" + "/";    //目标路径
        static private string ftpip = "192.168.3.187";    //ftp IP地址
        static private string username = "kingsunsoft.com\\ziwei.ma";   //ftp用户名
        static private string password = "333333";   //ftp密码
